...
class Skill:
    ...
    async def add_icon(self):
        icon = await pill.get_dowload_img(self.skill.icon.url, size= (56,60))
        self.background.alpha_composite(icon,(27,4))
    ...
    async def start(self):
        ...
        background.alpha_composite(self.background.resize((97,77)))
        background.alpha_composite(self.count,(27,57))
